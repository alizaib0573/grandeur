      ...
      5267: (t, e, i) => {
        ...
        var c = "LOADER_INIT",
          ...
          B = function (t) {
            ...
            if (C() && t.getBoundingClientRect().top > Z.winSize.height)
              return !1;
            return !0;
          },
          N = function (t) {
            ...
            return (
              ...
              (i = [
                ...
                },
                {
                  ...
                  value: function () {
                    (this.winSize = {
                      ...
                      (this.winSize.aspectRatio =
                        this.winSize.width / this.winSize.height),
                      (this.winSize.devicePixelRatio = 1),
                      (this.isResing = !0);
                  },
                },
                {
                    ...
                    window.addEventListener(
                      ...
                      this.isResizeObserver &&
                        new ResizeObserver(function () {
                          D.emit(f),
                            (t.isResing = !0),
                            t.timeOutResize && clearTimeout(t.timeOutResize),
                            (t.timeOutResize = setTimeout(function () {
                              t.isResing = !1;
                            }, 300));
                ...
                },
                {
                  key: "runClearEvents",
                  value: function () {
                    for (var t = 0; t < this.clearEvents.length; t++)
                      this.clearEvents[t]();
                    this.clearEvents = [];
                  },
                },
                {
                  ...
                  value: function (t) {
                    var e = t.path,
                      i = rt.lenis.scroll;
                    0 === this.scrollHistory.length
                      ? (this.scrollHistory[0] = {
                          path: e,
                          scrollTop: i,
                        })
                      : (1 === this.scrollHistory.length ||
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    D.on(h, function () {
                      ...
                      D.on(
                        "PAGE_BEFORE_LEAVE",
                        this.pageBeforeLeave.bind(this)
                      );
                  },
                },
              ]),
        ...
        var tt = (function () {
          function t(e) {
            ...
            var i =
              this.DOM.el.getAttribute("data-lenis-speed") ||
              this.DOM.el.getAttribute("data-lenis-parallax") ||
              0;
            (_() && 1 !== parseFloat(i)) ||
              ((this.handle = this.DOM.el.getAttribute("data-handle") || "all"),
              (this.isParallax =
                this.DOM.el.getAttribute("data-lenis-parallax") || !1),
              (this.props = {
              ...
              (this.propsParent = {}),
              (this.DOM.parent =
                this.DOM.el.closest(".js-lenis-speed__parent") ||
            ...
            (i = [
              {
                ...
                value: function () {
                  ...
                  (this.propsParent = K(K({}, this.propsParent), {
                    ...
                    (this.DOM.parent.style = "--pr-height: ".concat(
                      e.height,
                      "px;"
                    ));
                },
              },
              {
                ...
                value: function (t) {
                  if (!("lg" === this.handle && Z.winSize.width < 1200))
                    if (this.isParallax)
                      this.DOM.el.style = "--offset-parallax: ".concat(
                        t * this.props.parallax,
                        "px"
                      );
                    else {
                      ...
                      (n = Math.max(n, i)),
                        this.props.parallax >= 1 &&
                          (n = Math.max(
                            Math.min(n, this.propsParent.height),
                            0
                          )),
                        (this.props.current = n),
                        (this.DOM.el.style = "--offset-parallax: ".concat(
                          this.props.current,
                          "px"
                        ));
              ...
              },
              {
                ...
                value: function () {
                  D.on(f, this.getProp),
                    D.on(h, this.getProp),
                    Z.addClearEvent(this.clear.bind(this));
                },
              },
              {
                key: "clear",
            ...
            return (
              ...
              (i = [
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = t.scroll,
                      i = t.limit;
                    if (!this.isTouch)
                      for (var n = 0; n < this.parallaxs.length; n++)
                        this.parallaxs[n].scrolling(e, i);
                  },
                },
                {
                  key: "disabled",
                  value: function () {
                    (this.isEnabled = !1),
                      !this.isTouch && this.lenis.off("scroll", this.scrolling);
                  },
                },
                {
                  key: "enabled",
                  value: function () {
                    (this.isEnabled = !0),
                      !this.isTouch && this.lenis.on("scroll", this.scrolling),
                ...
                },
                {
                  ...
                  value: function (t) {
                    this.lenis.raf(t),
                      this.isEnabled && requestAnimationFrame(this.raf);
                  },
                },
                {
                  key: "pageLoaded",
                  value: function () {
                    ...
                    Z.isTouchDevice ||
                      document
                        .querySelectorAll(
                          "[data-lenis-speed], [data-lenis-parallax]"
                        )
                        .forEach(function (e) {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    D.on(w, function () {
                      ...
                      D.on(g, this.pageLoaded),
                      D.on(O, this.pageLeave);
                  },
                },
              ]),
              i && it(e.prototype, i),
        ...
        var ct = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              this.DOM.el.classList.contains("is-intersection") &&
                (this.isGsap = !1),
              this.addObServer(),
              this.bindEvent();
          }
            ...
            (i = [
              {
                ...
                value: function () {
                  var t = this;
                  this.DOM.el.parentElement.classList.add(
                ...
                value: function () {
                  ...
                  if (!this.isLoaded) {
                    ...
                    e.addEventListener("load", function () {
                      t.DOM.el.removeAttribute("data-srcset"),
                        t.DOM.el.removeAttribute("data-srcset-mobile"),
                        e.removeAttribute("data-srcset"),
                        e.removeAttribute("data-srcset-mobile"),
                        setTimeout(function () {
                    ...
                    i && (C() || z())
                      ...
                      : e.setAttribute(
                          "srcset",
                          this.DOM.el.getAttribute("data-srcset")
                        ),
                      this.DOM.el.parentElement.append(e),
                      this.destroy();
                  }
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  this.id &&
                    st.i.getById(this.id) &&
                    st.i.getById(this.id).kill(),
            ...
            (i = [
              {
                ...
                value: function (t) {
                  t
                    .querySelectorAll(".js-image--lazy:not(.is-handle)")
                    .forEach(function (t) {
                      new ht(t);
                    }),
                    C() &&
                      (t
                        .querySelectorAll(
                          ".js-lazy__webgl-image:not(.is-handle)"
                        )
                        .forEach(function (t) {
                          new ht(t);
                        }),
                      t
                        .querySelectorAll(
                          ".js-webgl-team--image:not(.is-handle)"
                        )
                        .forEach(function (t) {
                          new ht(t);
                        }));
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  document
                    .querySelectorAll(
                      "".concat(e, " .js-image--lazy:not(.is-handle)")
                    )
                    .forEach(function (t) {
                      new ht(t);
                    }),
                    C() &&
                      (document
                        .querySelectorAll(
                          "".concat(e, " .js-lazy__webgl-image:not(.is-handle)")
                        )
                        .forEach(function (t) {
                          new ht(t);
                        }),
                      document
                        .querySelectorAll(
                          "".concat(e, " .js-webgl-team--image:not(.is-handle)")
                        )
                        .forEach(function (t) {
                          new ht(t);
                        }));
              ...
              },
              {
                ...
                value: function () {
                  document
                    .querySelectorAll(".js-image--lazy")
                    .forEach(function (t) {
                      new ht(t);
                    }),
                    C() &&
                      (document
                        .querySelectorAll(".js-lazy__webgl-image")
                        .forEach(function (t) {
                          new ht(t);
                        }),
                      document
                        .querySelectorAll(".js-webgl-team--image")
                        .forEach(function (t) {
                          new ht(t);
                        }));
                },
            ...
            return (
              ...
              (i = [
                ...
                },
                {
                  ...
                  value: function (t) {
                    for (var e = 0; e < this.filterSvgLoader_.length; e++)
                      if (
                        this.filterSvgLoader_[e] &&
                        this.filterSvgLoader_[e].src === t
                      )
                        return e;
                    return !1;
                  },
                },
                {
                  ...
                  value: function (t) {
                    var e = this;
                    (this.DOM_.svgs = t.querySelectorAll("img.svg")),
                      this.DOM_.svgs.forEach(function (t) {
                  ...
                  value: function (t, e, i) {
                    ...
                    i.elements.forEach(function (t) {
                      ...
                      i && n.setAttribute("height", i),
                        ...
                        t.parentElement && (t.outerHTML = n.outerHTML);
                    });
                  },
                },
                {
                          ...
                          var t = function () {
                              ...
                              n.push(
                                new Promise(function (e) {
                                  i.caching[t.src]
                                    ? (i.initSvgIn(r, i.caching[t.src], t), e())
                                    : fetch(t.src)
                                        .then(function (t) {
                                          return t.text();
                                        })
                ...
                value: function () {
                  ...
                  this.timeClear && clearTimeout(this.timeClear),
                    ...
                    this.countTouch >= 3
                      ? ((this.countTouch = 0),
                        (this.enabled =
                          "false" === this.enabled ? "true" : "false"),
                        this.layout(),
                        localStorage.setItem("isGrid", String(this.enabled)))
                      : (this.timeClear = setTimeout(function () {
                          t.countTouch = 0;
                        }, 200));
                },
              },
        ...
        var Dt = (function () {
          function t() {
            !(function (t, e) {
              ...
              (this.onShowTimeout = !1),
              (this.callBeforeResize = !1),
              this.init(),
                ...
                value: function () {
                  this.fix100VhOnPhone(),
                    ...
                    document.body.insertAdjacentHTML(
                      "beforeend",
                      '<div id="layout-resize"></div>'
                    ),
                    (this.layoutReize =
                      document.querySelector("#layout-resize")),
                    this.bodyClass(),
                    this.getWin();
                },
              },
              {
                ...
                value: function () {
                  ...
                  C() && document.body.classList.add("is-mobile"),
                    _() && document.body.classList.add("is-touch"),
                    document
                      .querySelectorAll(
                        'a[href^="#"]:not(.has-tag-handle), a[href^="/#"]:not(.has-tag-handle)'
                      )
                      .forEach(function (e) {
                        var i = (function (t) {
                          return t.replace("/", "");
                        ...
                        H(i) &&
                          ...
                          (e.classList.add("has-tag-handle"),
                ...
                value: function () {
                  ...
                  (this.onShowTimeout = !1),
                    ...
                    this.winSize.width !== this.calcWinSize.width &&
                      ((this.winSize.width = this.calcWinSize.width),
                      D.emit("HT_RESIZE_WIDTH")),
                    this.winSize.height !== this.calcWinSize.height &&
                      ((this.winSize.height = this.calcWinSize.height),
                      D.emit("HT_RESIZE_HEIGHT")),
                    D.emit(h),
                    (this.callBeforeResize = !1),
                    ot.p8.to(this.layoutReize, {
                      duration: 0.5,
                      opacity: 0,
                      ease: "power3.inOut",
                      onComplete: function () {
                ...
                value: function () {
                  ...
                  window.addEventListener("load", function () {
                    ...
                    window.addEventListener("resize", function () {
                      t.calcWin(),
                        (!_() ||
                          (_() && t.winSize.width !== t.calcWinSize.width)) &&
                          ((t.winSize.width = t.calcWinSize.width),
                          t.onShowTimeout ||
                            ((t.onShowTimeout = !0),
                            ot.p8.set(t.layoutReize, {
                              opacity: 1,
                              zIndex: 9999,
                            })),
                          t.callBeforeResize ||
                            ((t.callBeforeResize = !0),
                            D.emit("BEFORE_HT_RESIZE")),
                          t.idSetTimeoutWindowResize &&
                            clearTimeout(t.idSetTimeoutWindowResize),
                          (t.idSetTimeoutWindowResize = setTimeout(
                            t.timeoutWindowResize,
                            350
                          )));
                    }),
                    D.on(g, this.bodyClass.bind(this)),
          ...
          return (
            ...
            (i = [
              ...
              },
              {
                key: "showDevInfo",
                value: function () {
                  for (var t in this.devInfo)
                    console.log(t.toString(), this.devInfo[t]);
                },
              },
              {
                key: "bindEvent",
        ...
        var _t = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              i.classList.add("is-handler", "is-anim-handler"),
              i.classList.remove("is-anim-loading"),
              (this.animated = !1),
              (this.isEnter = !1),
              (this.enterOnly = i.getAttribute("data-enteronly") || !1),
              (this.pageEnter = this.pageEnter.bind(this)),
              (this.id = (Math.random() + new Date().getTime()).toString()),
              this.bindEvent(),
              Z.addClearEvent(this.removeEvent.bind(this));
          }
          var e, i, n;
          return (
            (e = t),
            (i = [
                ...
                value: function () {
                  ...
                  if (null === this.animOb.offsetPercent) {
                    var o = i.getBoundingClientRect(),
                      s = o.height;
                    o.top >= Z.winSize.height &&
                      ((r = Lt(s / Z.winSize.height, 0, 1, 0.3, 0)),
                      (r = Math.max(Math.min(r, 0.3), 0)));
                  }
                  (r = i.getAttribute("data-threshold") || r),
                    st.i.create({
                      trigger: n || i,
                      markers: !1,
                      id: this.id,
                      ...
                      onLeave: function () {
                        t.enterOnly &&
                          (t.animOb.animUnset && t.animOb.animUnset(),
                          t.removeEvent(),
                          (t.isVisible = !1));
                      },
                    });
              ...
              },
              {
                ...
                value: function () {
                  var t = this.animOb,
                    ...
                    i = t.el,
                    n = Z.isScrolled()
                      ? parseFloat(i.getAttribute("data-offset")) || 0
                      : parseFloat(i.getAttribute("data-screen-offset")) || 0;
              ...
              },
              {
                key: "removeEvent",
                value: function () {
                  D.off(w, this.pageEnter),
                    this.id && st.i.getById(this.id).kill(),
                    (this.id = null);
                },
              },
            ]),
        ...
        var Wt = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              (B(this.DOM.el) || !i.handleScrolling || i.runMobile) &&
                this.DOM.el &&
                ((this.onHover = !1), (this.options = Ht({}, i)), this.init());
          }
          var e, i, n;
          return (
            (e = t),
            (i = [
              {
                ...
                value: function () {
                  ...
                  (this.options.from = Ht(Ht({}, t.from), this.options.from)),
                    (this.options.to = Ht(Ht({}, t.to), this.options.to)),
                    (this.options.out = Ht(Ht({}, t.out), this.options.out)),
                    this.DOM.el.classList.remove("is-anim"),
                    n || ot.p8.set(this.spliters.chars, this.options.from);
                },
              },
              {
                key: "animUnset",
              ...
              },
              {
                ...
                value: function () {
                  (this.spliters = new It.Z(this.DOM.el, {
                    ...
                    this.addAnimType(),
                    this.options.handleScrolling &&
                      (this.animHelper = new Ct({
                        el: this.DOM.el,
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (e.delay += t),
                    ot.p8.killTweensOf(this.spliters.chars),
                    this.options.type,
                    ot.p8.fromTo(this.spliters.chars, this.options.from, e);
                },
              },
              {
                key: "animOutTop",
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  (e.delay += t),
                    ot.p8.killTweensOf(this.spliters.chars),
                    this.options.type,
                    ot.p8.to(this.spliters.chars, e);
                },
              },
              {
                key: "animHover",
                value: function () {
                  ...
                  if (!this.onHover) {
                    ...
                    var e = Object.assign(
                      {
                        onComplete: function () {
                          (Object.assign({}, t.options.to).duration = 0.3),
                            ot.p8.fromTo(
                              t.spliters.chars,
                              t.options.from,
                              t.options.to
        ...
        var Kt = (function () {
          function t(e, i) {
            !(function (t, e) {
              ...
              this.DOM.el
                ? B(this.DOM.el) || !i.handleScrolling
                  ? (this.DOM.el.classList.add("anim--lines"),
                    (this.options = Ut({}, i)),
                    (this.animHelper = null),
                    this.addAnimType())
                  : this.DOM.el.classList.remove("is-anim-loading")
                : console.log("___not_el_AnimSimpleLine");
          }
          var e, i, n;
          return (
            (e = t),
            (i = [
              {
                ...
                value: function () {
                  var t, e, i;
                  ((e = (t = this).DOM.el).innerHTML =
                    "<span class='d-block line--mask-element'>".concat(
                      e.innerHTML,
                      "</span>"
                    )),
                    (t.DOM.elemntMask = e.querySelector(".line--mask-element")),
                    e.classList.add("only--line-mask"),
                    (i = {
                      from: {
                        y: "105%",
                      },
                    ...
                    (this.options.from = Ut(Ut({}, i.from), this.options.from)),
                    (this.options.to = Ut(Ut({}, i.to), this.options.to)),
                    (this.options.out = Ut(Ut({}, i.out), this.options.out)),
                    this.DOM.el.classList.remove("is-anim-loading"),
                    this.options.isHover
                      ? ((this.DOM.elemntMaskClose =
                          this.DOM.elemntMask.cloneNode(!0)),
                        this.DOM.elemntMaskClose.classList.add("is-clone"),
                        ot.p8.set(this.DOM.elemntMaskClose, this.options.from),
                        this.DOM.el.append(this.DOM.elemntMaskClose))
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (i.delay += e),
                    ...
                    ot.p8.killTweensOf(this.DOM.elemntMask),
                    ot.p8.fromTo(this.DOM.elemntMask, this.options.from, i);
                },
              },
              {
                key: "animInBack",
                value: function () {
                  ...
                  (e.delay += t),
                    ot.p8.killTweensOf(this.DOM.elemntMask),
                    ot.p8.to(this.DOM.elemntMask, e);
                },
              },
              {
                key: "animOut",
        ...
        var ne = (function () {
          function t(e) {
            ...
            if (
              ...
              (B(this.DOM.el) || !i.handleScrolling || i.runMobile)
                ? ((this.options = $t({}, i)), this.addAnimType())
                : this.DOM.el.classList.remove("is-anim-loading");
            ...
            (i = [
              {
                ...
                value: function () {
                  var t;
                  this.DOM.el.classList.add("anim--fade"),
                    this.options.type,
                    (t = {
                      from: {
                        opacity: 0,
                    ...
                    (this.options.from = $t($t({}, t.from), this.options.from)),
                    (this.options.to = $t($t({}, t.to), this.options.to)),
                    (this.options.out = $t($t({}, t.out), this.options.out)),
                    this.DOM.el.classList.remove("is-anim-loading"),
                    this.options.handleScrolling &&
                      (this.animHelper = new Ct({
                        el: this.DOM.el,
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (i.delay += e),
                    ot.p8.killTweensOf(this.DOM.el),
                    ot.p8.fromTo(this.DOM.el, this.options.from, i),
                    setTimeout(function () {
              ...
              },
              {
                ...
                value: function () {
                  ot.p8.killTweensOf(this.DOM.el),
                    ot.p8.set(this.DOM.el, this.options.from),
                    this.animHelper && this.animHelper.handleScrolling();
                },
              },
              {
                key: "animClearProp",
        ...
        var se = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              (this.DOM.action = this.DOM.el.children[0]),
              (this.motion = {
                current: {
                  x: 0,
                  y: 0,
            ...
            (i = [
              {
                ...
                value: function (t) {
                  ...
                  var e = 1 - Math.pow(0.001, t - this.raf);
                  (this.motion.current.x = xt(
                    this.motion.current.x,
                    this.motion.last.x,
                    e
                  )),
                    (this.motion.current.y = xt(
                      this.motion.current.y,
                      this.motion.last.y,
                      e
                    )),
                    (this.DOM.action.style.transform = "translate("
                      .concat(this.motion.current.x, "px, ")
                      .concat(this.motion.current.y, "px)")),
                    (this.raf = t);
                },
              },
              {
                  ...
                  var e,
                    ...
                    p = (function (t, e) {
                      ...
                      Math.min(
                        ...
                        (n = h),
                        (r = f),
                        Math.sqrt(Math.pow(e - n, 2) + Math.pow(i - r, 2))),
                        l / 2
                      ),
                      {
                        x: h,
          ...
          function t(e) {
            ...
            (this.DOM = {
              ...
              st.i.create({
                ...
                onToggle: function (t) {
                  t.isActive
                    ? (i.DOM.li.classList.add("is-active"), r(n))
                    : i.DOM.li.classList.remove("is-active");
                },
              }),
              this.bindEvent();
          }
          ...
          return (
            ...
            (i = [
              ...
              },
              {
                key: "addActive",
                value: function () {
                  this.DOM.li.classList.add("is-active"),
                    this.onEnter(this.DOM.el);
                },
              },
              {
                key: "onClick",
        ...
        var fe = (function () {
          function t() {
            ...
            !(function (t, e) {
              ...
              (this.DOM.logo = this.DOM.main.querySelector(".js-header_logo")),
              new se({
                el: this.DOM.logo,
              }),
              (this.elMenuItems = []),
        ...
        var de = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              this.DOM.el.classList.contains("js-simple-masking_el")
                ? (this.DOM.parent = this.DOM.el.closest(".heading-mask"))
                : this.DOM.el.classList.contains("heading-mask") &&
                  (this.DOM.parent = this.DOM.el),
              (this.onEnter = this.onEnter.bind(this)),
              (this.onLeave = this.onLeave.bind(this)),
              this.DOM.el.addEventListener("mouseenter", this.onEnter),
              this.DOM.el.addEventListener("mouseleave", this.onLeave);
          }
          var e, i, n;
          return (
            (e = t),
            (i = [
              {
                ...
                value: function () {
                  this.funs.onHover(),
                    this.DOM.parent &&
                      this.DOM.parent.classList.add("is-hover");
                },
              },
              {
                key: "onLeave",
                value: function () {
                  this.funs.onLeave(),
                    this.DOM.parent &&
                      this.DOM.parent.classList.remove("is-hover");
                },
              },
              {
                key: "clear",
                value: function () {
                  this.DOM.el.removeEventListener("mouseenter", this.onEnter),
                    this.DOM.el.removeEventListener("mouseleave", this.onLeave);
                },
              },
            ]) && ye(e.prototype, i),
            n && ye(e, n),
            ...
            (i = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  ot.p8.ticker.add(this.render),
                    document
                      .querySelectorAll(".js-cursor-extend")
                      .forEach(function (e) {
                        new de({
                          el: e,
                    ...
                    document
                      .querySelectorAll(".js-cursor-contract")
                      .forEach(function (e) {
                        new de({
                          el: e,
              ...
              },
              {
                ...
                value: function (t) {
                  null === this.raf && (this.raf = t);
                  var e = 1 - Math.pow(0.001, t - this.raf);
                  (this.cursor.current.x = xt(
                    this.cursor.current.x,
                    this.cursor.last.x,
                    e
                  )),
                    (this.cursor.current.y = xt(
              ...
              },
              {
                key: "renderStyle",
                value: function () {
                  this.DOM.main.style = "--size: "
                    .concat(this.cursor.value, "px; --x: ")
                    .concat(this.cursor.current.x, "px; --y: ")
                    .concat(this.cursor.current.y + this.cursor.scroll, "px;");
                },
              },
              {
                ...
                value: function () {
                  ...
                  ot.p8.killTweensOf(this.cursor),
                    ot.p8.to(this.cursor, {
                      ...
                      duration: 0.8,
                      onUpdate: function () {
                        t.DOM.main.style = "--size: "
                          .concat(t.cursor.value, "px; --x: ")
                          .concat(t.cursor.current.x, "px; --y: ")
                          .concat(t.cursor.current.y + t.cursor.scroll, "px;");
                      },
                    });
                },
              },
                ...
                value: function (t) {
                  ...
                  t.preventDefault(),
                    ...
                    ot.p8.to(this.cursor, {
                      ...
                      duration: 0.6,
                      onUpdate: function () {
                        e.DOM.main.style = "--size: "
                          .concat(e.cursor.value, "px; --x: ")
                          .concat(e.cursor.current.x, "px; --y: ")
                          .concat(e.cursor.current.y + e.cursor.scroll, "px;");
                      },
                    });
                },
              },
              {
                ...
                value: function () {
                  (this.handleMouseMoving = this.handleMouseMoving.bind(this)),
                    ...
                    this.DOM.btnClip.addEventListener(
                      "touchstart",
                      this.onDown
                    ),
        ...
        var Oe = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              (this.DOM.parent = this.DOM.paragraph.parentElement),
              (this.DOM.paragraphDeep = this.DOM.paragraph.cloneNode(!0)),
              this.DOM.parent.append(this.DOM.paragraphDeep),
              this.DOM.paragraphDeep.classList.add("is-bg"),
              this.DOM.paragraph.classList.add("is-masking"),
              this.DOM.parent.classList.add("scroll-paragraph-parent"),
              (this.currentPo = 0),
              this.init(),
              this.initScroller();
          }
            ...
            (i = [
              {
                ...
                value: function () {
                  ...
                  new ResizeObserver(
                    W(function () {
                      t.elMaskingText.split(),
                        e.split(),
                        t.onProgress(t.currentPo);
                    }, 500)
                  ).observe(this.DOM.parent);
                },
              },
              {
                key: "onProgress",
            ...
            function t(e) {
              ...
              !(function (t, e) {
                ...
                (this.DOM.heading = this.DOM.main.querySelector(
                  ".js-heading-mask_heading"
                )),
                (this.DOM.headingParent = this.DOM.heading.parentElement),
                (this.DOM.headingDeep = this.DOM.heading.cloneNode(!0)),
                this.DOM.headingParent.append(this.DOM.headingDeep),
                this.DOM.heading.classList.add("is-masking"),
                this.DOM.headingDeep.classList.add("is-deep"),
                this.initScroller();
            }
            var e, i, n;
            return (
              ...
              (i = [
                {
                  ...
                  value: function () {
                    ...
                    st.i.create({
                      ...
                      onUpdate: function (e) {
                        t.DOM.heading.style = "--size:".concat(
                          Lt(e.progress, 0, 1, 100, 0),
                          "%"
                        );
                      },
                    });
          ...
          function t(e) {
            ...
            !(function (t, e) {
              ...
              (this.DOM.videoInner = this.DOM.main.querySelector(
                ".js-videoPlayer_inner"
              )),
              (this.DOM.videoInnerRed = document.querySelector(
                ".js-videoPlayer_inner__red"
              )),
              (this.DOM.videoInRed =
                document.getElementById("videoPlayer_red")),
              (this.DOM.bigPlay =
                this.DOM.main.querySelector(".js-btnBigPlay")),
              (this.DOM.cursor = document.querySelector(".js-vj-cursor")),
              Z.isTouchDevice && this.DOM.main.classList.add("is-touch"),
              Z.isTouchDevice &&
                this.DOM.videoInnerRed.parentElement.classList.add("is-touch"),
              (this.timeSleepControl = null),
              (this.isActive = !1),
              (this.isFullSize = !1),
              (this.isfullScreen = !1),
              (this.props = {}),
            ...
            (i = [
              {
                ...
                value: function () {
                  ...
                  De.Z.hook("setup", function (n) {
                    ...
                    s.classList.add("icon"),
                      ...
                      (s.innerHTML = '\n                <img src="'
                        .concat(
                          e.pause,
                          '" class="icon-pause" alt="icon-pause" />\n                <img src="'
                        )
                        .concat(
                          e.play,
                          '" class="icon-play" alt="icon-play" />\n            '
                        )),
                      (a.innerHTML = '\n                <img src="'
                        .concat(
                          i.expend,
                          '" class="icon-expend" alt="icon-expend" />\n                <img src="'
                        )
                        .concat(
                          i.close,
                          '" class="icon-close" alt="icon-close" />\n            '
                        )),
                      r.appendChild(s),
                      o.appendChild(a),
                  ...
                  var n = this.player
                      .player()
                      .getAttribute("data-poster-mobile"),
                    r = this.player.player().getAttribute("data-src-mobile");
                  q() &&
                    ((n = this.player.player().getAttribute("data-poster")),
                    (r = this.player.player().getAttribute("data-src"))),
                    this.player.poster(n),
                    this.player.src(r),
                    this.DOM.videoInRed.setAttribute("src", r),
                    this.DOM.videoInRed.setAttribute("poster", n),
                    st.i.create({
                        ...
                        (t.isActive = e.isActive),
                          e.isActive
                            ? (t.playing(),
                              ...
                              Z.isTouchDevice ||
                                (t.getSize(),
                                ot.p8.killTweensOf(t.cursor),
                                ot.p8.ticker.add(t.loop)))
                            : (t.pauseVideo(),
                              (t.isFullSize = !1),
                              Z.isTouchDevice ||
                                (ot.p8.ticker.remove(t.loop), t.onLeave()));
                      },
                      onUpdate: function (e) {
                        if (!Z.isTouchDevice) {
                          var i = Lt(e.progress, 0, 0.5, 0, 1);
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.DOM.videoInnerRed.append(e),
                    this.DOM.videoInnerRed.addEventListener(
                      "click",
                      function () {
                    ...
                    (this.DOM.videoRed =
                      this.DOM.videoInnerRed.querySelector("video"));
                  var n = document.querySelectorAll("#videoPlayer");
                  n[1] && n[1].setAttribute("id", "videoPlayer_clone"),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  var e = 1 - Math.pow(0.001, t - this.cursor.raf);
                  (this.cursor.current.x = xt(
                    this.cursor.current.x,
                    this.cursor.last.x,
                    e
                    ...
                    (this.DOM.cursor.style = "--x:"
                      .concat(this.cursor.current.x, "px; --y:")
                      .concat(this.cursor.current.y, "px; --opacity: ")
                      .concat(this.cursor.opacity)),
                    (this.cursor.raf = t);
                },
              },
              {
                ...
                value: function (t) {
                  var e = Lt(t, 0, 1, 20, 0);
                  Z.isTouchDevice ||
                    (this.DOM.videoInner.style = "--size: ".concat(e, "%"));
                },
              },
              {
                key: "playing",
                value: function () {
                  this.player.paused()
                    ? (this.player.play(),
                      Z.isTouchDevice && this.DOM.videoInRed.play())
                    : (this.player.pause(),
                      Z.isTouchDevice && this.DOM.videoInRed.pause());
                },
              },
              {
                key: "pauseVideo",
                value: function () {
                  this.player.paused() ||
                    (this.timeSleepControl &&
                      clearTimeout(this.timeSleepControl),
                    this.player.pause(),
                    Z.isTouchDevice && this.DOM.videoInRed.pause());
                },
              },
              {
                ...
                value: function () {
                  (Z.isVideoFullScreen = this.player.isFullscreen()),
                    (this.isfullScreen = this.player.isFullscreen()),
                    this.player.currentTime(0),
                    Z.isTouchDevice && (this.DOM.videoInRed.currentTime = 0);
                  try {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.player.paused() ||
                    (this.timeSleepControl &&
                      clearTimeout(this.timeSleepControl),
                    this.player.contentEl().classList.remove("is-sleep"),
                    (this.timeSleepControl = setTimeout(function () {
                      t.sleepControl();
                    }, 1e3)));
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  this.player.isFullscreen() &&
                    this.player.contentEl().classList.add("is-sleep");
                },
              },
              {
                key: "onVideoClick",
                ...
                value: function () {
                  ...
                  ot.p8.killTweensOf(this.cursor),
                    ot.p8.to(this.cursor, {
                      ...
                      duration: 0.3,
                      onUpdate: function () {
                        t.DOM.cursor.style = "--x:"
                          .concat(t.cursor.current.x, "px; --y:")
                          .concat(t.cursor.current.y, "px; --opacity: ")
                          .concat(t.cursor.opacity);
                      },
                    });
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  var t = this;
                  D.on(h, this.getSize.bind(this)),
                    D.on(f, this.getSize.bind(this)),
                    window.addEventListener(
                      "mousemove",
                      this.winMouseMoving.bind(this)
                    ),
                    this.DOM.videoInner.addEventListener(
                      "mouseleave",
                    ...
                    this.DOM.bigPlay.addEventListener("click", function () {
                      return t.playing();
                    });
                },
              },
          ...
          function t(e) {
            ...
            !(function (t, e) {
              ...
              (this.DOM.list = this.DOM.main.querySelector(
                ".js-testimonial_lists"
              )),
              (this.DOM.testimonials =
                this.DOM.main.querySelectorAll(".js-testimonial")),
              (this.DOM.mainRed = document.querySelector(
                ".js-testimonials__red"
              )),
              (this.DOM.thumbListRed = document.querySelector(
                ".js-testimonials_thumbs_list__red"
              )),
              (this.DOM.listReds =
                this.DOM.thumbListRed.querySelectorAll(".thumb-item")),
              (this.oldActive = 0),
              this.DOM.testimonials.forEach(function (t, e) {
                new Ae({
                  el: t,
                  index: e,
            ...
            (i = [
              {
                key: "init",
                value: function () {
                  this.scrollMask && this.scrollMask.kill(),
                    this.scrollMain && this.scrollMain.kill();
                  var t = Z.winSize.height,
                    e = this.DOM.testimonials.length - 1,
                    i = this.DOM.testimonials[0]
                      .querySelector(".testimonial_inner")
                      .getBoundingClientRect(),
                    n = this.DOM.testimonials[e]
                      .querySelector(".testimonial_inner")
                      .getBoundingClientRect(),
                    r =
                      (this.DOM.thumbList.getBoundingClientRect(),
                      n.top - i.top + t / 2);
              ...
              },
              {
                key: "onActive",
                value: function (t) {
                  this.DOM.thumbItems[this.oldActive].classList.remove(
                    "is-active"
                  ),
                    this.DOM.listReds[this.oldActive].classList.remove(
                      "is-active"
                    ),
                    this.DOM.thumbItems[t].classList.add("is-active"),
                    this.DOM.listReds[t].classList.add("is-active"),
                    (this.oldActive = t),
                    (this.DOM.main.style = "--index: ".concat(t)),
                    (this.DOM.mainRed.style = "--index: ".concat(t));
                },
              },
              {
                key: "resize",
        ...
        var qe = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              (this.isVisible = !1),
              !I() || h
                ? (this.scrollTrigger = st.i.create({
                    trigger: n,
                    markers: p,
                    onEnter: r,
                    onEnterBack: s,
                ...
                : ((this.OBServer = new IntersectionObserver(
                    function (t) {
                      (i.isVisible = t[0].isIntersecting),
                        i.isVisible ? r && r() : a && a();
                    },
                    {
                      threshold: u,
            ...
            (i = [
              {
                ...
                value: function () {
                  this.OBServer && this.OBServer.unobserve(this.DOM.el),
                    this.OBServer && this.OBServer.disconnect(),
                    (this.isVisible = !1),
                    this.scrollTrigger && ot.p8.kill(this.scrollTrigger);
                },
              },
              {
                key: "isInViewPointer",
        ...
        var Ve = (function () {
            function t() {
              !(function (t, e) {
                ...
                (this.DOM.text =
                  this.DOM.main.querySelector(".js-loading_text")),
                (this.DOM.wrapText = document.getElementById(
                  "js-page-loading_text"
                )),
                (this.DOM.progress = document.getElementById(
                  "page-loading_circle"
                )),
                (this.DOM.btnStart = document.getElementById(
                  "js-page-loading_start"
                )),
                (this.DOM.logo = document.getElementById("page-loading_logo")),
                document.body.classList.add("js-ready", "is-loading"),
                D.emit(c),
                (this.processingLoading = this.processingLoading.bind(this)),
                ...
                (this.lowNet = 0),
                (this.timeOutTriggerPageEnter = 300),
              ...
              (i = [
                {
                  ...
                  value: function () {
                    D.emit(d),
                      this.DOM.main.classList.add("is-simple"),
                      document.hasFocus() || this.obServerAPI.isVisible
                        ? (this.obServerAPI.removeOb(),
                          (this.windowIsBlur = null),
                ...
                },
                {
                  ...
                  value: function () {
                    (this.obServerAPI = new qe({
                      ...
                      (this.idAnimationLoop = requestAnimationFrame(
                ...
                },
                {
                  ...
                  value: function () {
                    this.isReady &&
                      ((this.processing.runWidth +=
                        this.processing.delta + this.processing.percentStuck),
                      !this.windowLoaded ||
                      !this.isReady ||
                      this.registerCount > 0
                        ? ((this.processing.delta *= 0.5 - this.lowNet),
                          (this.processing.percentStuck += 0.05),
                          (this.processing.percentStuck *= 0.8),
                          this.processing.percentStuck >= 2 &&
                            (this.processing.percentStuck = 0))
                        : ((this.processing.delta = 5),
                          (this.processing.percentStuck = 0))),
                      (this.lowNet += 1e-4);
                    var t = parseInt(this.processing.runWidth);
                    (t = Math.min(t, this.minProgress)),
                      this.showOvalPress(t),
                      (this.DOM.wrapInner.style = "--po:".concat(
                        Lt(t, 0, 100, this.strokeDashoffset, 0)
                      )),
                      (this.DOM.text.textContent = t),
                      t >= 100 && 0 === this.registerCount
                        ? (this.runAnimation ||
                            ((this.runAnimation = !0), this.pageLoaded()),
                ...
                },
                {
                  ...
                  value: function () {
                    (this.DOM.main.style.visibility = "hidden"),
                      (this.DOM.main.style.zIndex = -999),
                      (this.DOM.main.style.clipPath = null);
                  },
                },
                {
                  key: "startIn",
                  value: function () {
                    ...
                    ot.p8.fromTo(
                      ...
                      },
                      {
                        ...
                        duration: 0.6,
                        onUpdate: function () {
                          t.DOM.wrapInner.style = "--po:"
                            .concat(e.value, "; --opacity:")
                            .concat(Lt(e.value, 0, -t.strokeDashoffset, 1, 0));
                        },
                      }
                    ),
                ...
                },
                {
                  ...
                  value: function () {
                    cancelAnimationFrame(this.idAnimationLoop),
                      ...
                      D.emit(g),
                      D.emit("PAGE_LOADED_ONE"),
                      this.clear(),
                      this.isSimpleLoader
                        ? this.startIn()
                        : (this.hide(),
                          D.emit("PAGE_ENTER_INTRO"),
                          new Ne(function () {
                            D.emit(w), D.emit(v);
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    new Ne(function () {
                      ...
                      D.emit(k),
                      ot.p8.to([this.DOM.logo, this.DOM.btnStart], {
                        opacity: 0,
                        stagger: 0.1,
                        ease: "power3.out",
                        duration: 0.3,
                ...
                },
                {
                  ...
                  value: function () {
                    (this.hideLoading = this.hideLoading.bind(this)),
                      (this.winFocus = this.winFocus.bind(this)),
                      (this.onStart = this.onStart.bind(this)),
                      (this.disabledTouch = this.disabledTouch.bind(this)),
                      window.addEventListener("focus", this.winFocus),
                      D.on(p, this.registerLoader),
                      D.on(y, this.unRegisterLoader),
                      window.addEventListener("load", this.hideLoading),
                      this.DOM.btnStart.addEventListener("click", this.onStart),
                ...
                },
                {
                  key: "clear",
                  value: function () {
                    window.removeEventListener("focus", this.winFocus),
                      D.off(p, this.registerLoader),
                      D.off(y, this.unRegisterLoader),
        ...
        var Ye = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              (this.DOM.txtOff = this.DOM.el.querySelector(
                ".js-footer_sound_list_item__off"
              )),
              (this.DOM.txtOn = this.DOM.el.querySelector(
                ".js-footer_sound_list_item__on"
              )),
              (this.funs = {
                onClick: n,
              }),
              (this.isStatus = "on"),
              ot.p8.set(this.DOM.txtOff, {
                y: "100%",
              }),
        ...
        var Je = (function () {
          function t() {
            ...
            !(function (t, e) {
              ...
              (this.elBtns = []),
              document
                .querySelectorAll(".js-footer_sound")
                .forEach(function (t) {
                  e.elBtns.push(
                    new Ye({
                      el: t,
            ...
            (i = [
              {
                key: "toggleAudio",
                value: function () {
                  this.isAudioPlay ? this.fadeOut() : this.fadeIn(),
              ...
              },
              {
                ...
                value: function () {
                  this.playAudio(),
                    ot.p8.killTweensOf(this.DOM.player),
                    ot.p8.fromTo(
                      this.DOM.player,
                      {
                        volume: 0,
              ...
              },
              {
                key: "bindEvent",
                value: function () {
                  D.on(S, this.fullScreenBackToPlay.bind(this)),
                    D.on(M, this.pauseAudio.bind(this)),
                    D.on(k, this.toggleAudio.bind(this));
                },
              },
            ]) && Ke(e.prototype, i),
            n && Ke(e, n),
        ...
        var di = (function () {
            function t() {
              ...
              (this.camera = new ii.cPb(s, r, 1, 300)),
                this.camera.position.set(0, 0, this.perspective),
                (this.camera.aspect = r),
                (this.clock = new ii.SUY()),
                (this.renderList = []),
                (this.props = {
                  scrollTop: 0,
                }),
                ...
                (this.clearColor = new ii.Ilk("#000")),
                (this.idAnim = null),
                (this.loaderGLTF = new fi()),
                (this.render = this.render.bind(this)),
                this.addObjects(),
                this.getViewSize(),
                this.bindEvents();
            ...
            return (
              ...
              (i = [
                ...
                },
                {
                  ...
                  value: function () {
                    var t = (this.camera.fov * Math.PI) / 180,
                      e = Math.abs(
                        this.camera.position.z * Math.tan(t / 2) * 2
                      );
                    this.pointView = {
                ...
                },
                {
                  key: "initLight",
                  value: function () {
                    var t = new ii.Ox3(16777215, 0.5);
                    t.position.set(0, 1, 1),
                      t.scale.multiplyScalar(20),
                      this.scene.add(t);
                    var e = new ii.vmT(16777215, 16777215, 0.5);
                    e.color.setHSL(0.6, 1, 0.6),
                      e.groundColor.setHSL(0.095, 1, 0.75),
                      e.position.set(0, 0, 0),
                      e.scale.multiplyScalar(150),
                      this.scene.add(e);
                    var i = new ii.Mig(16777215, 0.5);
                    this.scene.add(i);
                    var n = new ii.cek(16777215, 0.2);
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    (this.camera.aspect = n),
                      ...
                      (this.uniforms.iResolution.value.x = e),
                      (this.uniforms.iResolution.value.y = i),
                      (this.camera.fov =
                        (2 * Math.atan(i / 2 / this.perspective) * 180) /
                        Math.PI),
                ...
                },
                {
                  key: "pageLoaded",
                  value: function () {
                    this.idAnim && cancelAnimationFrame(this.idAnim),
                      this.resizeRendererToDisplaySize(this.renderer),
                      this.isHasWork && this.render();
                  },
                },
                {
                  key: "pageLeave",
                ...
                },
                {
                  ...
                  value: function () {
                    this.loop(),
                      (this.idAnim = requestAnimationFrame(this.render));
                  },
                },
                {
                  key: "mouseMove",
                  value: function (t) {
                    var e = Z.getSize(),
                      i = e.width,
                      n = e.height;
                    (this.mouse.x = (t.clientX / i) * 2 - 1),
                      (this.mouse.y = (-t.clientY / n) * 2 + 1),
                      ai.uniforms.iMouse.value.set(this.mouse.x, this.mouse.y);
                  },
                },
                {
                  key: "bindEvents",
                  value: function () {
                    (this.mouseMove = this.mouseMove.bind(this)),
                      ...
                      D.on(h, this.onWindowResize),
                      window.addEventListener("mousemove", this.mouseMove),
                      Z.isTouchDevice
                        ? window.addEventListener("scroll", this.loop)
                        : rt.lenis.on("scroll", this.loop),
                      D.on(O, this.pageLeave),
                      D.on(m, this.addObjects),
                      D.on(w, this.pageLoaded);
                  },
                },
                {
                  key: "clear",
        ...
        var gi = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              Ge.registerLoader(),
              (this.sceneInfo = this.makeScene(this.DOM.el)),
              (this.current = new ii.Pa4()),
              (vi.isHasWork = !0),
              (this.render = this.render.bind(this)),
              vi.renderList.push(this.render),
              (this.isInview = !s),
              vi.loaderGLTF
                .resolve({
                  url: r,
              ...
              },
              {
                ...
                value: function () {
                  if (this.isInview) {
                    ...
                    vi.renderer.setScissor(r, o, e, i),
                      vi.renderer.setViewport(r, o, e, i);
                    var s = this.sceneInfo,
                      a = s.scene,
                      l = s.camera;
                    (l.aspect = e / i),
                      l.updateProjectionMatrix(),
                      vi.renderer.render(a, l);
                  }
                },
              },
            ]) && bi(e.prototype, i),
        ...
        function Si(t) {
          for (var e = 1; e < arguments.length; e++) {
            var i = null != arguments[e] ? arguments[e] : {};
            e % 2
              ? Oi(Object(i), !0).forEach(function (e) {
                  Mi(t, e, i[e]);
                })
              : Object.getOwnPropertyDescriptors
              ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i))
              : Oi(Object(i)).forEach(function (e) {
                  Object.defineProperty(
                    t,
                    e,
                    Object.getOwnPropertyDescriptor(i, e)
        ...
        function ki(t, e) {
          for (var i = 0; i < e.length; i++) {
            ...
            (n.enumerable = n.enumerable || !1),
              (n.configurable = !0),
              "value" in n && (n.writable = !0),
              Object.defineProperty(t, Di(n.key), n);
          }
        }
            ...
            (i = [
              {
                ...
                value: function (t) {
                  var e = this;
                  this.rotation && this.mesh.rotation.copy(this.rotation),
                    this.position && this.mesh.position.copy(this.position),
                  ...
                  st.i.create({
                    ...
                    onUpdate: function (t) {
                      var i = t.progress;
                      (e.mesh.rotation.x = Lt(i, 0, 1, 0, 1.5)),
                        (e.mesh.rotation.y = Lt(i, 0, 1, 0, 2));
                    },
                  });
                },
              },
        ...
        function Ai(t) {
          for (var e = 1; e < arguments.length; e++) {
            var i = null != arguments[e] ? arguments[e] : {};
            e % 2
              ? xi(Object(i), !0).forEach(function (e) {
                  Ri(t, e, i[e]);
                })
              : Object.getOwnPropertyDescriptors
              ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i))
              : xi(Object(i)).forEach(function (e) {
                  Object.defineProperty(
                    t,
                    e,
                    Object.getOwnPropertyDescriptor(i, e)
            ...
            (i = [
              {
                ...
                value: function (t) {
                  ...
                  st.i.create({
                    ...
                    onUpdate: function (t) {
                      var i = t.progress;
                      (e.mesh.rotation.z = Lt(i, 0, 1, 0.5, 1)),
                        (e.mesh.rotation.x = Lt(i, 0, 1, -0.25, 1)),
                        (e.mesh.rotation.y = Lt(i, 0, 1, -0.5, 0));
                    },
                  });
                },
              },
        ...
        var Fi = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              (this.state = {
                coffeeRotation: new ii.Pa4(0.29, -0.68, -0.42),
                mouseRotation: new ii.Pa4(0.84, 0.15, 0.84),
                coffeeScroller: new ii.Pa4(-0.05, 0.05, 0.01),
                mouseScroller: new ii.Pa4(-0.05, -0.05, 0.01),
              });
            var n = this.DOM.main.querySelector(".js-about_ido_coffee");
            n &&
              (this.obCoffee = new Ti({
                el: n,
                url: "assets/glb/coffee.min.gltf",
                scroller: this.state.coffeeScroller,
                rotation: new ii.USm(
                  this.state.coffeeRotation.x,
                  this.state.coffeeRotation.y,
                  this.state.coffeeRotation.z,
                  "XYZ"
                ),
              }));
            ...
            r &&
              (this.obMouse = new Hi({
                ...
                rotation: new ii.USm(
                  this.state.mouseRotation.x,
                  this.state.mouseRotation.y,
                  this.state.mouseRotation.z,
                  "XYZ"
                ),
              })),
            ...
            (i = [
              {
                ...
                value: function (t) {
                  z()
                    ? this.mesh.scale.setScalar(1.7)
                    : this.mesh.scale.setScalar(1.9),
                    this.mesh.traverse(function (t) {
                      t.isMesh &&
                        ((t.material.metalness = 0),
                        (t.material.roughness = 0.75));
                    });
                },
              },
              {
                ...
                value: function () {
                  ...
                  st.i.create({
                    ...
                    onUpdate: function (e) {
                      t.mesh &&
                        (t.mesh.rotation.y = Lt(e.progress, 0, 1, -2, -0.8));
                    },
                    onToggle: function (e) {
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  e.position.set(1, 0.08, -0.05), t.add(e);
        ...
        var Qi = Ji(function t() {
          ...
          var i,
            n = this.DOM.videoPlayer.getAttribute("data-pc").toString(),
        ...
        ot.p8.registerPlugin(st.i),
          ot.p8.registerPlugin(at.L),
          new ((function () {
            function t() {
              !(function (t, e) {
                if (!(t instanceof e))
            ...
            return (
              ...
              (i = [
                ...
                },
                {
                  ...
                  value: function () {
                    document
                      .querySelectorAll(".js-scroll-paragraph-mask")
                      .forEach(function (t) {
                        new Oe({
                          paragraph: t,
                        });
                      ...
                      document
                        .querySelectorAll(".js-heading-mask")
                        .forEach(function (t) {
                          new ke({
                            heading: t,
                          });
                    ...
                    var e,
                      i = document.querySelector(".js-testimonials");
                    if (
                      (i &&
                        new Ce({
                          main: i,
                      ...
                      new Qi(),
                      new Je(),
                      (e = document.querySelector(".js-pageContent")) &&
                        (e
                          .querySelectorAll(".js-anim--chars:not(.is-handler)")
                          .forEach(function (t) {
                            new Wt(t, {
                              handleScrolling: !0,
                              runMobile: !0,
                        ...
                        e
                          .querySelectorAll(".js-anim--scale:not(.is-handler)")
                          .forEach(function (t) {
                            new ne(t, {
                              handleScrolling: !0,
                            });
                        ...
                        e
                          .querySelectorAll(
                            ".js-anim--lines--sim:not(.is-handler)"
                          )
                          .forEach(function (t) {
                            new Kt(t, {
                              handleScrolling: !0,
                ...
                },
                {
                  ...
                  value: function () {
                    this.initModules(),
                      bt.renderSvgElement(
                        document.querySelector(".js-pageContent")
                      );
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    window.addEventListener(
                      "mousemove",
                      this.onMoving.bind(this)
                    ),
                      D.on(d, this.initGlobal.bind(this)),
                      D.on(m, this.pageAfter.bind(this)),
                      D.on(b, this.winPageLoaded.bind(this));
                  },
                },
              ]) && tn(e.prototype, i),
              n && tn(e, n),
  ...
  (n.m = e),
    ...
    (n.O = (e, i, r, o) => {
      if (!i) {
        ...
        for (c = 0; c < t.length; c++) {
          for (var [i, r, o] = t[c], a = !0, l = 0; l < i.length; l++)
            (!1 & o || s >= o) && Object.keys(n.O).every((t) => n.O[t](i[l]))
              ? i.splice(l--, 1)
              : ((a = !1), o < s && (s = o));
          if (a) {
            t.splice(c--, 1);
    ...
    (() => {
      ...
      var e = (e, i) => {
          ...
          for (e && e(i); u < s.length; u++)
            (o = s[u]), n.o(t, o) && t[o] && t[o][0](), (t[o] = 0);
          return n.O(c);
        },
        i = (self.webpackChunkwebpack_boilerplate =
